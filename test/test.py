...
async def test_project(dut):
    ...
    rx7 = await spi_transfer_16(dut, 0x0000)  # 0.0
    change_ss(dut, 1)
    ...
    assert rx7 == 0x40BA, (f"ERROR rx1: expected=0x0000 received=0x{rx1:04X}")
    
    dut._log.info("All MAC tests completed")
